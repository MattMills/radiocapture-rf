...
from ltr_control_receiver import ltr_control_receiver
...
class receiver(gr.top_block):
	...
	def __init__(self):
		...
		for system in self.systems:
			...
			elif self.systems[system]['type'] == 'ltr':
                                self.systems[system]['block'] = ltr_control_receiver( self.systems[system], self.sources[0]['samp_rate'], self.sources, self, system)
			else:
